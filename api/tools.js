...
async function images(req,res) {
  ...
  try {
    const homeUrl='https://duckduckgo.com/?q='+encodeURIComponent(q);\n    const home=await fetch(homeUrl,{headers:ddgHeaders()});
